...
│   │   └── tools/
│   │       ├── definitions/
│   │       │   ├── grantsgov-get-opportunity.tool.test.ts
│   │       │   ├── grantsgov-list-reference.tool.test.ts
│   │       │   └── grantsgov-search-opportunities.tool.test.ts
│   │       ├── input-schemas.test.ts
│   │       └── render.test.ts
│   ├── services/
│   │   └── grants-gov/
│   │       ├── grants-gov-service.test.ts
